...
<?php if ($this->poemData): ?>
    ...
    <div class="language-content">
        <h3> Language: </h3>
        <a href="../../../poezie/<?php echo $this->poemData->autor_id . '/' . $this->poemData->titlu_ro . '/' ?>english">
            English </a>
        <a href="../../../poezie/<?php echo $this->poemData->autor_id . '/' . $this->poemData->titlu_ro . '/' ?>french">
            French </a>
    </div>
    <hr class="hr1">
