...
<article>
    ...
    <section>
        ...
        <p>
            &emsp; &emsp; Pentru a stoca informațiile despre poezii, autori, useri avem nevoie de o baza de date. Baza de date contine următoarele tabele:
        </p>
        <ol>
            <li> <em>User</em> reține toate informațiile de care este nevoie pentru profilul userilor: username, email, profile picture, descriere, etc. </li>
            <li> <em>Poezie română</em> reține toate informațiile despre poezia în română.</li>
            <li> <em>Poezie tradusă</em> reține informațiile despre traducerile introduse de către useri cât și limba în care este tradusă. </li>
            <li> <em>Strofa tradusă</em> reține datele celui care a tradus strofa, strofa în sine, numărul acesteia, cât și rating-ul împreună cu vizualizările sale. </li>
    ...
    <section>
        ...
        <p> User-ul va putea sa vizualizeze site-ul chiar daca nu detine un cont, dar acesta nu va avea dreptul la adaugarea de noi traduceri, comentarii, share sau rating, respectiv tot ce tine de profilul unui utilizator care detine un cont, insa va putea sa citeasca poezii, traduceri, comentarii si sa se informeze despre orice detalii legate de noile traduceri ale poemelor, despre cei mai activi useri sau cele mai comentate poezii.</p>
        <figure typeOf = "sa:image">
    ...
    <section>
        ...
        <section>
            <ul>
                <li>signup - posibilitatea unui utilizator de a-și face un cont și de a beneficia de anumite funcționalități</li>
                <li>login - posibilitatea de a se conecta la contul sau.</li>
                <li>RSS_tabel_traduceri_noi - posibilitatea utilizatorilor de a vedea cele mai noi traduceri ce vor fi expuse via un flux de știri RSS.</li>
                <li>setari - accesul la adaugarea unei descrieri sau poze, modificarea parolei, cat si posibilitatea de a se deconecta.</li>
                <li>adaugarePoza - posibilitatea unui utilizator logat de a-și adăuga o poză de profil</li>
                <li>adaugareDescriere - posibilitatea unui utilizator de a-și adăuga o descriere(citat, motto,etc) la profil</li>
                ...
                <li>celeMaiComentatePoezii - posibilitatea utilzatorilor de a vedea topul cu cele mai comentate poezii</li>
                <li>tabelPoezii - afisarea tuturor poeziilor ale poetului selectat</li>
                <li>vizualizarePoezie - posibilitatea de a vedea toate traducerile poeziei selectate, respectiv comentarii, adnotari, cat si distribuirea poeziei pe o platforma cum ar fi WordPress, Medium sau Blogspot</li>
                <li>traducereStrofa - posibilitatea de a adăuga o nouă traducere unei strofe de către un utilizator logat</li>
                <li>adaugaAdnotare - posibilitatea de a adăuga o adnotare unei strofe de către un utilzator logat</li>
                <li>comentariuStrofa - posibilitatea unui utilizator logat să își exprime părerea în legutură cu o strofă tradusă într-un comentariu</li>
                <li>comentariuPoezie - la fel ca funcționalitatea precedentă doar că comentariu este adăugat la întreaga poezie</li>
                <li>sharePoem - posibilitatea unui utilizator logat de a distribui un poem pe o platforma de blogging</li>
                <li>stergereComentariu - posibiliatea administratorului de a ștege comentarii( considerate neadecvate sau din alte motive) adăugate unor strofe  de utilizatori sau intregii poezii</li>
                <li>stergereTraducere - posibilitatea administratorului de a șterge anumite traduceri adăugate de utilizatori</li>
                <li>stergereAdnotare - posibilitatea administratorului de a șterge anumite adnotari adăugate de utilizatori</li>
                <li>vizualizareTraduceri - userii, traducatorii, cat si adminii site-ului pot vizualiza toate traducerile disponibile</li>
                <li>vizualizareComentarii - userii, traducatorii si adminii site-ului pot vizualiza comentariile traducerilor cat si comentariile intregii poezii</li>
    ...
    <section>
        ...
        <ol>
            ...
            <li>Popularea bazei de date (cu poeme și autori în stadiul de început, după care vor fi inserate date la efectuarea operațiilor în aplicație);</li>
            <li>
                Elaborarea modelului:
                <ul>
                    <li>Realizarea legăturii cu baza de date;</li>
                    <li>Crearea modelelor care se vor ocupa cu interogarea bazei de date.</li>
                    <li>Crearea de controllere prin care apelăm funcțiile implementate în modele și salvarea datelor returnate de către funcțiile din modele în view pentru ca mai târziu să se poată
                        utiliza aceste date în anumite scopuri(listarea autorilor, prezentarea poeziilor, comentariilor, adnotărilor, etc.)</li>
                </ul>
            </li>
    ...
    <section>
        <h2>7. Împărțirea task-urilor</h2>
        <ul>
            <li>
            ...
            <li>
                Cota Stefan-Octavian se va ocupa de: adaugare_comentarii, adaugare_adnotari, adaugare_rating, adaugare_traducere, share, stergereComentarii, stergereTraduceri.
            </li>
        </ul>
    </section>
    <section>
        ...
        <ol>
            ...
            <li><a href = "https://profs.info.uaic.ro/~adiftene/Scoala/2019/IP/index.html"> Diagrame UML, USE CASE, C4. </a></li>
            <li><a href = "https://profs.info.uaic.ro/~andrei.panu/"> Resurse legate de proiect </a></li>
            <li><a href = "https://profs.info.uaic.ro/~busaco/teach/courses/web/web-projects.html"> Informare necesare pentru realizarea componentelor cât și a unor funcționalități. </a></li>
