...
<div id = "about-us-container">
    <h1> <img src = "/assets/images/mission.png" class = "mission-img" alt = ""> Misiunea noastră! </h1>
    <p> A asigura cele mai bune traduceri pentru iubitorii de literatură! </p>
    <h3> <img src = "/assets/images/about-us.png" class = "about-img" alt =""> Despre </h3>
    ...
    <h3><img src = "/assets/images/contact.png" class = "about-img" alt = ""> Contact! </h3>
    <div id = "contact">
        <p> <img src = "/assets/images/mail.png" class = "mail-img" alt = ""> octavian_cota@yahoo.com </p>

        <p> <img src = "/assets/images/phone.png" class = "phone-img" alt = ""> 0753485821</p>

        <p> <img src = "/assets/images/mail.png" class = "mail-img" alt = ""> biancabacaoanu@yahoo.com</p>

        <p> <img src = "/assets/images/phone.png" class = "phone-img" alt = ""> 0758104472 </p>
    </div>
